...
{
    public interface IAddStudentToClassroomService
    {
        Output Execute(int studentId, int classroomId);
    }
    public class AddStudentToClassroomService : IAddStudentToClassroomService
    {
        private readonly IClassroomRepository _classroomRepository;
        private readonly IStudentRepository _studentRepository;
        public AddStudentToClassroomService(IClassroomRepository classroomRepository, IStudentRepository studentRepository)
        {
