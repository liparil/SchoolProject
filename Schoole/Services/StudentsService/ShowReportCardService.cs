...
{
    public interface IShowReportCardService
    {
        Output Execute(int studentId);
    }
    internal class ShowReportCardService : IShowReportCardService
    {
        private readonly IStudentRepository _studentRepository;
        public ShowReportCardService(IStudentRepository studentRepository)
        {
